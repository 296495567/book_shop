...
<div class="bk_title_bar">
  <img src="/images/back.png" alt="" class="bk_back" onclick="history.go(-1)">
  <p class="bk_title_content"></p>
  <img src="/images/menu.png" alt="" class="bk_menu" onclick="onMenuClick();">
</div>
<div class="page">
  @yield('content')
</div>
...
<div id="actionSheet_wrap">
    ...
    <div class="weui_actionsheet" id="weui_actionsheet">
        <div class="weui_actionsheet_menu">
            ...
            <div class="weui_actionsheet_cell" onclick="onMenuItemClick(5)">注销登录</div>
        </div>
...
function onMenuItemClick(index) {
  ...
  if(index == 1) {
    ...
    window.location="/order_list"
  }else if(index == 5){
    window.location="/service/loginout"
  } else {
    $('.bk_toptips').show();
